...
public class LoadModelsTest extends BaseScreen {
	...
	public void show() {
		...
		assets.load("loadmodels/data/Only_Spider_with_Animations_Export.obj", Model.class);
		loading = true;
	...
	private void doneLoading() {
		Model ship = assets.get("loadmodels/data/Only_Spider_with_Animations_Export.obj", Model.class);
